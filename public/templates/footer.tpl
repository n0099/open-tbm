<footer class="page-footer purple lighten-1">
    <div class="container">
        <div class="row">
            ...
            <div class="col l4 offset-l2 s12 white-text">
                <h5>相关联系方式</h5>
                <ul>
                    <li><a class="grey-text text-lighten-3" href="https://n0099.cf/">n0099 四叶重工的博客</a></li>
                    <li>QQ四叶重工群：292311751</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="footer-copyright">
        <div class="container">
            © 2015-2017 四叶重工 <a href="https://www.infstudio.net">Infinity Studio</a> 提供服务器支持
        </div>
    </div>
</footer>
</html>