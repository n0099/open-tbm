namespace tbm.Crawler
{
        ...
        where TResponse : IMessage<TResponse> where TPostProtoBuf : IMessage<TPostProtoBuf>
    {
        ...
        protected abstract IEnumerable<(Task<TResponse>, CrawlRequestFlag)> RequestsFactory(Page page);
        ...
        public Task<(TResponse, CrawlRequestFlag)[]> CrawlSinglePage(Page page) =>
            Task.WhenAll(RequestsFactory(page).Select(async i => (await i.Item1, i.Item2)));
